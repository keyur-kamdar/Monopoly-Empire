...
{
    class SolarPowerBonus : Cards
    {

        public void Action(MonopolyEmpires Me)
        {
            Type type_Space = Type.GetType("Empire_Monopoly.Spaces.ElectricCompany");
            ...
            if (count > 0)
            {
                ...
                Me.BuyBrandForChanceCard(billBoardSize, price, img, "ElectricCompany", true);
            }
